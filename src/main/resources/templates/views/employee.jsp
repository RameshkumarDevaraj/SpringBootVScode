...
<head>
    ...
    <style type="text/css">
        ...
        .empTable td{font-family:Arial, sans-serif;font-size:16px;padding:10px 5px;
        ...
        .empTable th{font-family:Arial, sans-serif;font-size:16px;font-weight:normal;padding:10px
                              5px;border-style:solid;border-width:2px;overflow:hidden;word-break:normal;
                              border-color:#ccc;color:#000000;background-color:#FF4500;
                              }
